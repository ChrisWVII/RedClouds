...
def BandWindow():         # Input bandwidth & message size
    ...
    MessageLabel1.grid(row=1,column=0)              # 
    MessageEntry.grid(row=1,column=1)               # 
    MessageLabel2.grid(row=1,column=2,sticky='w')   # 
    SubmitButton.grid(row=2,column=2)               #
    BandWin.mainloop()                              # 
...
def SettingWindow():      # Change other variables
    ...
    def GetSet():
        global EarthLink,MarsLink,NoiseAmp,Utilisation,Heat,MTTR,RunOutChance,HumanError,RackMTBF
    ...
    RunOutEntry.insert(0,100*RunOutChance)                                                             # 
...
def Delay(s=0):
    ...
    TransDelay=MessageSize*8/Bandwidth
...
def Variables():   # Everything is global for simplicity
    ...
    TierBoundaries={0:'< Tier 1',0.99671:'Tier I',0.997:'Tier I-II',                        # \
                    ...
                    0.99987:'Tier III-IV',0.99995:'Tier IV'}                                # /

    ## Date-based Variables:
    global Date,RelVel,RelAcc,PlanetsDict,Distance,PropDelay,EffectiveDistance,SentFreq,Bandwidth,FreqShift,RecievedFreq,MessageSize,Obstacles,SentAmps,SNR
    ...
    ## Other Variables:
    global SortOrder,Reverse,MarsLink,EarthLink,NoiseAmp,Utilisation,Heat,MTTR,RunOutChance,HumanError,RackMTBF
